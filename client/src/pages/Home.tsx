  ...
  return (
    <main>
      ...
      <section className="downloads section-paper" id="downloads">
        <div className="container downloads-layout"><div><SectionMarker number="GET THE BUILD" label="Загрузки" /><h2>Поставить<br /><span>на устройство.</span></h2><p>Альфа-сборки уже опубликованы в репозитории. Перед подключением радиошлюза изучите руководство по настройке оборудования и региональным ограничениям.</p></div><div className="download-list"><a className="download-card" href="https://github.com/Ksyushka666/radioshare/releases/download/v0.1.1-alpha/RadioShare-0.1.1-alpha.exe" target="_blank" rel="noreferrer"><div className="download-icon"><Radio size={22} /></div><div><span className="mono">DESKTOP CLIENT</span><strong>RadioShare для Windows</strong><small>Windows 10/11 · x64 · Alpha 0.1.1</small></div><span className="download-arrow"><ArrowUpRight size={17} /></span></a><a className="download-card" href="https://github.com/Ksyushka666/radioshare/releases/download/v0.1.1-alpha/RadioShare-0.1.1-alpha.apk" target="_blank" rel="noreferrer"><div className="download-icon"><Smartphone size={22} /></div><div><span className="mono">MOBILE CLIENT</span><strong>RadioShare для Android</strong><small>Android 9+ · APK · Alpha 0.1.1</small></div><span className="download-arrow"><ArrowUpRight size={17} /></span></a><div className="download-note"><span className="status-dot" /> <a href="https://github.com/Ksyushka666/radioshare/releases/tag/v0.1.1-alpha" target="_blank" rel="noreferrer">Смотреть все файлы последнего Alpha Release <ArrowUpRight size={14} /></a></div></div></div>
      </section>
